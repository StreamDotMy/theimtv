    ...
    <div class="col-md">
        ...
        <div class="input-group">
            ...
            <div class="custom-file">
                <input type="file" name="avatar" class="custom-file-input @error('avatar') is-invalid @enderror" id="inputGroupFile01"
...
<div class="form-group row">
    ...
    <div class="col-md">
        <textarea name="address" id="" cols="30" rows="10" class="form-control  @error('address') is-invalid @enderror">{{ $profile->address }}</textarea>
